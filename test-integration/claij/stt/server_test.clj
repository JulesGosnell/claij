(ns ^:python-required claij.stt.server-test
...
;; Note: start-server! and stop-server! tests with actual Whisper backend
;; require Python environment with whisper, torch, etc.
;; These are integration tests that should run with: clojure -M:whisper:test
