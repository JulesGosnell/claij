(ns ^:needs-cuda claij.stt.whisper.audio-test
  "Tests for audio conversion that require Python/CUDA environment.
   These tests need: numpy, soundfile, libpython-clj, and CUDA GPU.
   Run on CUDA-capable machine with: clojure -M:whisper:test --focus :needs-cuda"
